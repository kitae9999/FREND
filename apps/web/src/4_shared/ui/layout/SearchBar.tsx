  ...
  return (
    <form className="relative h-[45px] w-full max-w-xl" role="search">
      ...
      <input
        ...
        className="h-[45px] w-full rounded-[12px] border border-[#2A2A3E] bg-[#18181C] pl-10 pr-3 text-sm text-[#99A1AF] placeholder:text-[#99A1AF] outline-none focus:ring-2 focus:ring-[#ED1B25]"
      />
    </form>
  );
};
